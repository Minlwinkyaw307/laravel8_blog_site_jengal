                        ...
                        <div class="row">
                            <div class="col-md-8 offset-md-2 row">
                                ...
                                <x-admin::select-input
                                    ...
                                    :required="true"
                                >
                                    <a href="{{ route('admin.blog-status.create') }}">Create New Blog Status</a>
                                </x-admin::select-input>
                                ...
                                <div class="col-md-2 offset-md-10">
                                    <button
                                        class="btn cur-p btn-primary w-100">{{ is_null($id) ? 'Submit' : 'Update' }}</button>
                                </div>
                                @if(!is_null($id))
                                    <div class="col-md-12 row">
                                        ...
                                        @foreach($item->blog_comments as $comment)
                                            <a href="{{ route('admin.blog-comment.edit', $comment->id) }}" class="col-6 d-flex p-2 c-grey-100 mb-1">
